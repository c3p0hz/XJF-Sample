...
public class XjfNettyClientImpl extends XjfNettyClient {

    public XjfNettyClientImpl(String host, int port) {
        super(host, port);
    }

    public XjfNettyClientImpl(String host, int port, int maxMsgSize) {
